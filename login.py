...
In this study, you will be reading a short passage about a character. You will then will be asked to make a number of simple judgments about that passage (the passage will be shown for each question, so that you may reread if needed). There is no right or wrong answer, we are just interested in our opinion.
<br><br>
